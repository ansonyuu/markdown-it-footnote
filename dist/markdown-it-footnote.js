/*! markdown-it-footnote 3.0.3 https://github.com//markdown-it/markdown-it-footnote @license MIT */ (function (
  f
) {
      ...
      1: [
        function (require, module, exports) {
          ...
          function render_footnote_ref(tokens, idx, options, env, slf) {
            var id = slf.rules.footnote_anchor_name(
              tokens,
              idx,
              options,
              env,
            ...
            var caption = slf.rules.footnote_caption(
              tokens,
              idx,
              options,
              env,
            ...
            return (
              '<sup class="footnote-ref"><a href="#fn-anchor' +
              id +
              '" id="fnref-intext' +
              refid +
              '">' +
          ...
          function render_footnote_open(tokens, idx, options, env, slf) {
            ...
            return '<li id="fn-anchor' + id + '" class="footnote-item">';
          }
          ...
          module.exports = function footnote_plugin(md) {
            ...
            function footnote_ref(state, silent) {
              ...
              if (
                typeof state.env.footnotes.refs[":" + label] === "undefined"
              ) {
                return false;
              }
